...
# [START env_variables]
GCP_PROJECT_ID = getenv("GCP_PROJECT_ID", "estudo-328318")
REGION = getenv("REGION", "us-east1")
LOCATION = getenv("LOCATION", "us-east1")
LANDING_BUCKET_ZONE = getenv("LANDING_BUCKET_ZONE", "estudo_spark")
...
PYSPARK_URI = getenv("PYSPARK_URI", "gs://estudos-script-spark/cobranca.py")
...
# [START set_tasks]
    ...
    # https://registry.astronomer.io/providers/google/modules/dataprocsubmitpysparkjoboperator
